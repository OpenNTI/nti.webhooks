...
#
# html_title = u'nti.webhooks v1.0'
...
latex_documents = [
    (master_doc, 'ntiwebhooks.tex', u'nti.webhooks Documentation',
...
man_pages = [
    (master_doc, 'ntiwebhooks', u'nti.webhooks Documentation',
     [author], 1)
]
...
extlinks = {'issue': ('https://github.com/NextThought/nti.webhooks/issues/%s',
                      'issue #'),
            'pr': ('https://github.com/NextThought/nti.webhooks/pull/%s',
                   'pull request #')}
